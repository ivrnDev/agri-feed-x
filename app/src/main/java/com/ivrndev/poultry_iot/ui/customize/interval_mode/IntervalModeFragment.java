package com.ivrndev.poultry_iot.ui.customize.interval_mode;
...
public class IntervalModeFragment extends Fragment {
    private CustomizeIntervalModeBinding binding;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater,
        ...
        binding = CustomizeIntervalModeBinding.inflate(inflater, container, false);
